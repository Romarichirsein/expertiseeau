          ...
          const mockPosts = [
            {
              ...
              excerpt: "Analyse approfondie des récentes données pluviométriques et des stratégies de résilience pour les zones urbaines du pays.",
              content: "Le stress hydrique devient une réalité préoccupante pour de nombreuses villes camerounaises. Avec le changement climatique, la périodicité des pluies a été perturbée, affectant la recharge des nappes phréatiques.\n\n### Un constat alarmant\n\nLes données recueillies par les stations météorologiques montrent une baisse significative de la pluviométrie dans les régions septentrionales, mais aussi un décalage des saisons dans les zones forestières. Cette instabilité complique la planification urbaine et la gestion des réseaux de distribution d'eau.\n\n### Vers des solutions durables\n\nCet article explore les solutions d'ingénierie verte et la gestion intégrée des ressources en eau (GIRE) comme moyens de mitigation. Il est impératif d'investir dans des infrastructures de stockage plus résilientes et de promouvoir une culture de l'économie d'eau à tous les niveaux de la société.",
  ...
  if (loading) {
    return (
      <div className="flex flex-col items-center justify-center py-60 space-y-8">
        ...
        <p className="text-gray-400 font-black uppercase tracking-[0.2em] text-xs">{isFR ? 'Préparation de la lecture...' : 'Preparing reading...'}</p>
      </div>
    );
  }
