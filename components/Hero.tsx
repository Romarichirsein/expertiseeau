...
export const Hero = ({ locale }: HeroProps) => {
  ...
  return (
    <section className="relative h-[80vh] min-h-[600px] flex items-center overflow-hidden bg-[#2794e8]">
      ...
      {/* Decorative Elements */}
      <div className="absolute bottom-0 right-0 w-1/3 h-1/3 bg-white/5 rounded-full blur-3xl -mb-20 -mr-20" />
      <div className="absolute top-0 left-0 w-1/4 h-1/4 bg-white/5 rounded-full blur-3xl -mt-20 -ml-20" />
    </section>
  );
};
